...
import { SignInAdminDto } from '../dtos';
// import { RequestOtpDto } from '../dtos/forgot-req-otp.dto';
// import { generateOtp } from '@src/common/functions/otp.function';
// import { ForgotCredentialsService } from './forgot-credentials.service';
// import { ZensivaService } from '../services/zensiva.service';
...
export class AuthAdminService {
  constructor(
    ...
    // private readonly zensivaService: ZensivaService,
  ...
  //   // Check if admin record still exists before updating
  //   const adminExists = await this.adminRepository.findUniqueOrThrow({
  //     id: admin.id,
  //   });
